...
// Orden de la tabla/tablero: por defecto los más recientes primero;
// clickeando la columna # se puede ordenar por consecutivo asc/desc.
export function compararReportes(a, b, orden) {
  if (orden === 'consecutivo_asc') return a.consecutivo - b.consecutivo;
  if (orden === 'consecutivo_desc') return b.consecutivo - a.consecutivo;
